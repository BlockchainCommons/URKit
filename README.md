...
- [URDemo](https://github.com/BlockchainCommons/URDemo) — Demonstrates URKit by sending and receiving long binary messages via animated QR codes containing multi-part URs.
...
To financially support further development of **URKit** and other projects, please consider becoming a Patron of Blockchain Commons through ongoing monthly patronage as a [GitHub Sponsor](https://github.com/sponsors/BlockchainCommons). You can also support Blockchain Commons with bitcoins at our [BTCPay Server](https://btcpay.blockchaincommons.com/).
